...
class DrivableAreaViolationStatistics(MetricBase):
    ...
    def __init__(
        self, name: str, category: str, lane_change_metric: EgoLaneChangeStatistics, max_violation_threshold: float
    ) -> None:
        """
        Initialize the DrivableAreaViolationStatistics class.
    ...
    def extract_metric(self, history: SimulationHistory) -> Tuple[List[float], bool]:
        """
        Extract the drivable area violations from the history of Ego poses.
